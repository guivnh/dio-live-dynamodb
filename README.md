...
aws dynamodb query \
    ...
    --expression-attribute-values  '{":artist":{"S":"Aerosmith"}}'
```
...
aws dynamodb query \
    ...
    --expression-attribute-values  '{":name":{"S":"Pink"}}'
```
...
aws dynamodb query \
    ...
    --expression-attribute-values  '{":v_artist":{"S":"Aerosmith"},":v_title":{"S":"Monkey on My Back"} }'
```
...
aws dynamodb query \
    ...
    --expression-attribute-values  '{":v_song":{"S":"Pink"},":v_year":{"S":"1997"} }'
```
